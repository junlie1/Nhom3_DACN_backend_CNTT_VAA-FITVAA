...
app.use(cors({
    origin: ['http://localhost:3000','http://localhost:8008','http://localhost:8008', 'http://192.168.99.239:8008', 'http://42.113.117.188:8008', 'http://democode.ddns.net:8008','http://democode.ddns.net:8008/','https://junwoan-clothes.vercel.app'], // URL của frontend React
